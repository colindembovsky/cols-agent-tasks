...
let a: ma.TaskLibAnswers = <ma.TaskLibAnswers>{
    ...
    "glob": {
        ...
        "testing\\appsettings.json" : [ path.join("testing", "appsettings.json") ]
    }
};
tmr.setAnswers(a);
...
// validate the replacement
let actual2 = (<any>_mockfs).readFileSync('testing/appsettings.json', 'utf-8');
