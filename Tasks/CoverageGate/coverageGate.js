...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            var covData = yield testApi.getCodeCoverageSummary(teamProject, buildId);
            ...
            if (covData) {
                ...
                if (trends.length === 0) {
                    tl.setResult(tl.TaskResult.Failed, `There is are no coverate deltas. Make sure you have at least 2 builds.`);
                }
...
run();
//# sourceMappingURL=coverageGate.js.map