...
describe('replaceTokensInPaths', function () {
    before(() => {
    });
    ...
    it('should succeed with default inputs', (done: MochaDone) => {
        ...
        let tp = path.join(__dirname, 'replaceTokensInPaths', 'test-normalInputs.js');
        let tr: ttm.MockTestRunner = new ttm.MockTestRunner(tp);
    ...
    it('should succeed with empty path', (done: MochaDone) => {
        ...
        let tp = path.join(__dirname, 'replaceTokensInPaths', 'test-emptyPath.js');
        let tr: ttm.MockTestRunner = new ttm.MockTestRunner(tp);
    ...
    it('should succeed with @ tokens', (done: MochaDone) => {
        ...
        let tp = path.join(__dirname, 'replaceTokensInPaths', 'test-atTokens.js');
        let tr: ttm.MockTestRunner = new ttm.MockTestRunner(tp);
    ...
    it('should succeed with dotted tokens', (done: MochaDone) => {
        ...
        let tp = path.join(__dirname, 'replaceTokensInPaths', 'test-dotTokens.js');
        let tr: ttm.MockTestRunner = new ttm.MockTestRunner(tp);
